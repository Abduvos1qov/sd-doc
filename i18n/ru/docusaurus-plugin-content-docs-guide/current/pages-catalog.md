...
### 3.6 Неподтверждённые клиенты (очередь одобрения)
...
### 6.2 Планирование по торговой точке
...
### 7.5 Отчёт по работе экспедиторов
...
- Фильтры: категория клиента, канал, агент, товар / категория
- Столбцы: название правила, к чему применяется, размер (% или фикс.), срок действия

Куда дальше:
- **Клик «+ Добавить»** → форма нового правила скидки

### 12.5 Правила бонусов
...
- Фильтры по товару, бренду, категории
